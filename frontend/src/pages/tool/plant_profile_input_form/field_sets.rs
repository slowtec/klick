    ...
    vec![
        FieldSet {
            ...
            fields: vec![
                ...
                Field {
                    id: Id::PopulationEquivalent.into(),
                    description: Some(
        ...
        FieldSet {
            ...
            fields: vec![
                Field {
                    id: Id::from(AnnualAverageInfluentId::ChemicalOxygenDemand).into(),
                    description: Some(
                ...
                Field {
                    id: Id::from(AnnualAverageInfluentId::Nitrogen).into(),
                    description: Some(
                ...
                Field {
                    id: Id::from(AnnualAverageInfluentId::Phosphorus).into(),
                    description: Some(
        ...
        FieldSet {
            ...
            fields: vec![
                Field {
                    id: Id::from(AnnualAverageEffluentId::ChemicalOxygenDemand).into(),
                    description: Some(
                ...
                Field {
                    id: Id::from(AnnualAverageEffluentId::Nitrogen).into(),
                    description: Some(
                ...
                Field {
                    id: Id::from(AnnualAverageEffluentId::Phosphorus).into(),
                    description: Some(
        ...
        FieldSet {
            ...
            fields: vec![
                Field {
                    id: Id::from(EnergyConsumptionId::SewageGasProduced).into(),
                    description: Some(
                ...
                Field {
                    id: Id::from(EnergyConsumptionId::MethaneFraction).into(),
                    description: Some(
                ...
                Field {
                    id: Id::from(EnergyConsumptionId::GasSupply).into(),
                    description: Some(
                ...
                Field {
                    id: Id::from(EnergyConsumptionId::PurchaseOfBiogas).into(),
                    description: Some(
                ...
                Field {
                    id: Id::from(EnergyConsumptionId::TotalPowerConsumption).into(),
                    description: Some(
                ...
                Field {
                    id: Id::from(EnergyConsumptionId::OnSitePowerGeneration).into(),
                    description: Some(
                ...
                Field {
                    id: Id::from(EnergyConsumptionId::EmissionFactorElectricityMix).into(),
                    description: Some(
        ...
        FieldSet {
            ...
            fields: vec![
                Field {
                    id: Id::from(SewageSludgeTreatmentId::DigesterCount).into(),
                    description: Some(
                ...
                Field {
                    id: Id::from(SewageSludgeTreatmentId::SewageSludgeForDisposal).into(),
                    description: Some(
                ...
                Field {
                    id: Id::from(SewageSludgeTreatmentId::TransportDistance).into(),
                    description: Some(
        ...
        FieldSet {
            ...
            fields: vec![
                Field {
                    id: Id::from(OperatingMaterialId::FeCl3).into(),
                    description: Some(
                ...
                Field {
                    id: Id::from(OperatingMaterialId::FeClSO4).into(),
                    description: Some(
                ...
                Field {
                    id: Id::from(OperatingMaterialId::CaOH2).into(),
                    description: Some(
                ...
                Field {
                    id: Id::from(OperatingMaterialId::SyntheticPolymers).into(),
                    description: Some(
