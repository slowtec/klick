...
pub fn CH4EmissionsOpenSludgeStorage(
    ...
    view! {
      ...
      <Card id = "sensitivity-sludge-storage" title = "Methanemissionen aus der Schlammlagerung" bg_color="bg-blue" accessibility_always_show_option>
        <InfoBox text = " Emissionen aus der Schlammlagerung aerob-stabilisierter Schlämme weisen ein deutliches Emissionspotenzial auf" accessibility_always_show_option>
