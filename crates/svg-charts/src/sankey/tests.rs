...
fn test_layers_sort() {
    ...
    deps.insert(
        NodeId(3),
        Dependencies {
            inputs: vec![NodeId(0), NodeId(1), NodeId(2)],
            outputs: vec![],
        },
    );
    let (mut final_root_layers, final_leafs_layers) =
...
fn test_layers_fork_sort() {
    ...
    deps.insert(
        NodeId(4),
        Dependencies {
            inputs: vec![NodeId(0), NodeId(1), NodeId(2), NodeId(3)],
            outputs: vec![],
        },
    );
    let (mut final_root_layers, final_leafs_layers) =
    ...
    assert_eq!(
        final_root_layers,
        vec![
            vec![NodeId(1), NodeId(2), NodeId(0), NodeId(3)],
            vec![NodeId(4)]
        ]
    );
}
