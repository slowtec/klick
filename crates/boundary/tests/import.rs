...
fn import_v1() {
    ...
    let SewageSludgeTreatment {
        ...
        // FIXME: sludge_bags_factor,
        sludge_storage_containers_are_closed,
        // FIXME: sludge_storage_containers_factor,
    ...
    // FIXME: assert_eq!(custom_sludge_bags_factor, None);
    assert_eq!(sludge_storage_containers_are_closed, Some(false));
    // FIXME: assert_eq!(custom_sludge_storage_containers_factor, None);
